...
You configure this bot in three places: a `.env` file for secrets, the Lavalink bootstrap in `bot.py`, and `application.yml` for the audio server itself. Understanding where each setting lives — and how they must stay in sync — helps you move the bot between machines or tune playback safely. For the full variable reference, see [Environment Variables](/setup/environment-variables).
...
<CardGroup cols={2}>
  <Card title="Environment Variables" icon="key" href="/setup/environment-variables">
    Review the exact .env values the bot reads at startup.
  </Card>

  <Card title="Lavalink Setup" icon="docker" href="/guides/lavalink-setup">
    Follow the Docker guide for the audio node that your config points to.
  </Card>

  <Card title="Bot Setup" icon="discord" href="/guides/bot-setup">
    Register and invite the Discord application that uses these settings.
  </Card>

  <Card title="Quickstart" icon="rocket" href="/quickstart">
    Move from setup to a working local bot in a few minutes.
  </Card>
</CardGroup>