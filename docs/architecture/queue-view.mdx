...
<CardGroup cols={2}>
  <Card title="Overview" icon="book-open-lines" href="/architecture/overview">
    See how the full Nextcord, Wavelink, and Lavalink stack fits together.
  </Card>

  <Card title="Queue Commands" icon="people-line" href="/commands/queue">
    Learn how the queue browser is exposed to users from the slash command layer.
  </Card>

  <Card title="Playback Commands" icon="play" href="/commands/playback">
    Review the commands that start and advance playback for the queue you are browsing.
  </Card>

  <Card title="Configuration" icon="gear" href="/get-started/configuration">
    Verify the Lavalink and bot settings that support the queue experience.
  </Card>
</CardGroup>