...
<Steps>
  ...
  <Step title="Install Python dependencies">
    Run `uv sync` from the project root to install runtime and development dependencies.
  </Step>
  ...
  <Step title="Run the bot">
    Execute `uv run python bot.py` — the bot registers all slash commands on startup and connects to Lavalink automatically.
  </Step>
</Steps>
