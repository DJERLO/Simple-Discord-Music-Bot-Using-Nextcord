---
title: "Deploy Lavalink via Docker for Your Discord Music Bot"
...
<CardGroup cols={2}>
  <Card title="Bot Setup" icon="discord" href="/guides/bot-setup">
    Configure the Discord application that will connect to this Lavalink node.
  </Card>

  <Card title="Environment Variables" icon="key" href="/setup/environment-variables">
    Check the .env values used by the bot when it starts up.
  </Card>

  <Card title="Quickstart" icon="rocket" href="/get-started/quickstart">
    Follow the end-to-end path from setup to first playback.
  </Card>

  <Card title="Configuration" icon="gear" href="/get-started/configuration">
    Review the full audio and permission settings used by the bot stack.
  </Card>
</CardGroup>