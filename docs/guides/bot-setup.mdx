...
<CardGroup cols={2}>
  <Card title="Lavalink Setup" icon="docker" href="/guides/lavalink-setup">
    Run the audio server your bot connects to during startup.
  </Card>

  <Card title="Environment Variables" icon="key" href="/setup/environment-variables">
    Confirm every value the bot expects from your .env file.
  </Card>

  <Card title="Quickstart" icon="rocket" href="/quickstart">
    Use the setup steps to bring the bot up locally.
  </Card>

  <Card title="Configuration" icon="gear" href="/configuration">
    Compare the bot, Lavalink, and permission settings in one place.
  </Card>
</CardGroup>